...
namespace GoldenChequeBackEnd.Service.Features.CustomerFeatures.Commands
{
    public class DeleteCustomerByIdCommand : IRequest<int>
    {
        ...
        public class DeleteCustomerByIdCommandHandler : IRequestHandler<DeleteCustomerByIdCommand, int>
        {
            ...
            //    return customer.Id;
            //}
            public Task<int> Handle(DeleteCustomerByIdCommand request, CancellationToken cancellationToken)
            {
